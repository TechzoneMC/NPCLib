...
public class EntityNPCCaveSpider extends EntityCaveSpider implements LivingHookable {
    ...
    public EntityNPCCaveSpider(World world, LivingNPC npc, LivingNPCHook hook) {
        super(world);
        this.npc = npc;
        setHook(hook);
    }
