...
public class EntityNPCEnderDragon extends EntityEnderDragon implements LivingHookable {
    ...
    public EntityNPCEnderDragon(World world, LivingNPC npc, LivingNPCHook hook) {
        super(world);
        this.npc = npc;
        setHook(hook);
    }
