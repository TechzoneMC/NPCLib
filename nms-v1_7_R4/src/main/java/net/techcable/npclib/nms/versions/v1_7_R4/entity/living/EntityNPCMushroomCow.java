...
public class EntityNPCMushroomCow extends EntityMushroomCow implements LivingHookable {
    ...
    public EntityNPCMushroomCow(World world, LivingNPC npc, LivingNPCHook hook) {
        super(world);
        this.npc = npc;
        setHook(hook);
    }
